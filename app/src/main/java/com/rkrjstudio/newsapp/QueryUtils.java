    ...
    private static List<News> extractFeatureFromJson(String newJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newArray.length(); i++) {
                JSONObject properties = newArray.getJSONObject(i);
                ...
                if (properties.has("title")) {
                    type = properties.getString("title");
                }
                ...
                String time = null;
                if (properties.has("publishedAt")) {
                    time = properties.getString("publishedAt");
                }
                ...
                String image = null;
                if (properties.has("urlToImage")) {
                    image = properties.getString("urlToImage");
                }
                ...
                News newFinal = new News(type, author, time, description, image, url);
